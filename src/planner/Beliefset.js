export default class Beliefset {
    ...
    addObject(obj) {
        if (!(typeof obj === "string")) throw "String expected, got " + typeof obj + ": " + obj
    ...
    declare(fact, value = true) {
        if (!(typeof fact === "string")) throw "String expected, got " + typeof fact + ": " + fact
        if (fact.split(" ")[0] == "not") throw "Fact expected, got a negative literal: " + fact
